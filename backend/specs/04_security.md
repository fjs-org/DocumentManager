...
- **Credentials for Basic Auth:** 
  - User and password for BASIC AUTH are taken from environment variables `BASIC_AUTH_USERNAME`, `BASIC_AUTH_PASSWORD` (for spring.security.user.name and spring.security.user.password).
  - NEVER store any sensitive information in the source code or version control. 
